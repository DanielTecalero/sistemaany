...
class AdminView(generics.CreateAPIView):
    ...
    # @transaction.atomic
    # def delete(self, request, *args, **kwargs):
    #     id_administrador = kwargs.get('id_administrador', None)
    #     if id_administrador:
    #         try:
    #             administrador = Administradores.objects.get(id=id_administrador)
    #             user = administrador.user
    #             user.is_active = 0
    #             user.save()
    #             return Response({"message":"Administrador con ID "+str(id_administrador)+" eliminado correctamente."},200)
    #         except Administradores.DoesNotExist:
    #             return Response({"message":"Administrador con ID "+str(id_administrador)+" no encontrado."},404)
