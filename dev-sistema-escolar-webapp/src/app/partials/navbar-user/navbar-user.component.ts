...
export class NavbarUserComponent implements OnInit {
  ...
  public goMaestros() {
    this.router.navigate(["registro-usuarios/maestros"]);
  }

  public goAlumnos() {
    this.router.navigate(["registro-usuarios/alumnos"]);
  }

  public goAdministradores() {
    this.router.navigate(["registro-usuarios/administrador"]);
  }
