...
export class AlumnosService {
  ...
  public validarAlumno(data: any, editar: boolean){
    ...
    } else if (!this.validatorService.alphanumeric(data["matricula"])) {
      error["matricula"] = this.errorService.alphanumeric;
    }
    ...
    } else if (!this.validatorService.curpFormat(data["curp"])) {
      error["curp"] = this.errorService.curpFormat;
